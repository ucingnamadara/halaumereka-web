...
export function About() {
  return (
    <div
      id="about"
      className="container:none flex flex-col lg:flex-row items-center justify-center gap-14 py-32 px-20 bg-black text-white"
    >
      <img src={HalauMerekaBlackLogo} className="h-max w-[500px]" />
      <div className="flex flex-col gap-4">
        <h1 className="text-3xl md:text-4xl font-semibold text-yellow-500">
          Who We Are
        </h1>
